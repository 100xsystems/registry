...
knowledge_refs:
  - languages/javascript/js-13-modules-syntax
prerequisites:
  - "JS-01 through JS-08"
  - "JS-10: Async"
references:
    ...
    - title: "Exploring JS: JavaScript for Programmers"
      url: "https://exploringjs.com/js/ch_modules.html"
      chapters: "[Ch. 12: Destructuring](https://exploringjs.com/js/ch_destructuring.html) | [Ch. 15: Modules](https://exploringjs.com/js/ch_modules.html)"
...
- *Reference:* [javascript.info — Modules](https://javascript.info/service-workersservice-workersmodules-intro) | MDN — JavaScript modules | Exploring JS Ch. 15
...
- *Reference:* [javascript.info — Optional chaining](https://javascript.info/service-workersservice-workersoptional-chaining), ?., ?? | MDN — ES2020-2023 features
