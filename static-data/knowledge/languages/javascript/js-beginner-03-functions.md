...
knowledge_refs:
  - languages/javascript/js-beginner-03-functions
prerequisites:
...
- *Reference:* javascript.info — Functions, Function expressions | Eloquent JS Ch. 3
...
- *Reference:* javascript.info — Recursion and stack | Eloquent JS Ch. 3
