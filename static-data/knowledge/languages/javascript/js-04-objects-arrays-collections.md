...
knowledge_refs:
  - languages/javascript/js-04-objects-arrays-collections
prerequisites:
...
references:
    ...
    - title: "Exploring JS: JavaScript for Programmers"
      url: "https://exploringjs.com/js/ch_objects.html"
      chapters: "[Ch. 10: Objects](https://exploringjs.com/js/ch_objects.html) | [Ch. 22: Arrays](https://exploringjs.com/js/ch_arrays.html) | [Ch. 23: Maps and Sets](https://exploringjs.com/js/ch_maps-sets.html)"
...
- *Reference:* [javascript.info — Objects](https://javascript.info/service-workersservice-workersobject) | Eloquent JS Ch. 4 | MDN — Working with Objects
...
- *Reference:* [javascript.info — Object methods, "this"](https://javascript.info/service-workersservice-workersobject-methods) | [MDN — Object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/export/Statements/export/Global_Objects/Object)
...
- *Reference:* [javascript.info — Arrays](https://javascript.info/service-workersservice-workersarray) | Eloquent JS Ch. 4
...
- *Reference:* [javascript.info — Array methods](https://javascript.info/service-workersservice-workersarray-methods) | Eloquent JS Ch. 5 (Higher-Order Functions)
...
- *Reference:* [javascript.info — Destructuring assignment](https://javascript.info/service-workersservice-workersdestructuring-assignment) | Exploring JS Ch. 12
...
- *Reference:* [javascript.info — Map and Set](https://javascript.info/service-workersservice-workersmap-set), WeakMap and WeakSet | YDKJSY ES.Next Ch. 5
