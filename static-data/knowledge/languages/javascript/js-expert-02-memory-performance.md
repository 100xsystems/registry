...
knowledge_refs:
  - languages/javascript/js-expert-02-memory-performance
prerequisites:
  - "JS-01 through JS-14"
references:
    - title: "MDN Web Docs"
    ...
    - title: "Exploring JS: JavaScript for Programmers"
      ...
      chapters: "Ch. 17: Memory and Performance"
...
- *Reference:* MDN — Memory Management | javascript.info — Garbage collection
