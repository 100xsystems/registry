...
knowledge_refs:
  - languages/javascript/js-05-dom-browser-apis
prerequisites:
...
- *Reference:* [javascript.info — DOM tree](https://javascript.info/service-workersservice-workersdom-nodes) | Eloquent JS Ch. 14 | MDN — Node
...
- *Reference:* [javascript.info — Searching DOM](https://javascript.info/service-workersservice-workerssearching-elements-dom) | MDN — Document.querySelector
...
- *Reference:* [javascript.info — Modifying document](https://javascript.info/service-workersservice-workersmodifying-document) | Eloquent JS Ch. 14
...
- *Reference:* [javascript.info — Events](https://javascript.info/service-workersservice-workersevents) | Eloquent JS Ch. 15 | MDN — Event
