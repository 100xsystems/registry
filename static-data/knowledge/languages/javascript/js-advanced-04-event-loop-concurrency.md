...
knowledge_refs:
  - languages/javascript/js-advanced-04-event-loop-concurrency
prerequisites:
...
- *Reference:* javascript.info — Event loop | YDKJSY Sync & Async Ch. 1 | MDN — Event loop
...
- *Reference:* MDN — Web Workers API | javascript.info — Web Workers
