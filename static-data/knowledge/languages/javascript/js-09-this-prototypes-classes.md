...
knowledge_refs:
  - languages/javascript/js-09-this-prototypes-classes
prerequisites:
  - "JS-08: Scope and Closures"
references:
    - title: "You Don't Know JS Yet"
      url: "https://github.com/getify/you-dont-know-js/blob/2nd-ed/objects-classes/ch1.md"
    ...
    - title: "Exploring JS: JavaScript for Programmers"
      url: "https://exploringjs.com/js/ch_classes.html"
      chapters: "[Ch. 10: Objects](https://exploringjs.com/js/ch_objects.html) | [Ch. 14: Classes](https://exploringjs.com/js/ch_classes.html)"
...
- *Reference:* [YDKJSY — Objects & Classes Ch. 1](https://github.com/getify/you-dont-know-js/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/objects-classes/ch1.md)-2 | javascript.info — Object methods, this
  | [MDN — this](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/export/Statements/export/Operators/this) | Eloquent JS Ch. 6
...
- *Reference:* [YDKJSY — Objects & Classes Ch. 5](https://github.com/getify/you-dont-know-js/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/objects-classes/ch5.md) | [javascript.info — Prototypal inheritance](https://javascript.info/service-workersservice-workersprototype-inheritance)
...
- *Reference:* [YDKJSY — Objects & Classes Ch. 6](https://github.com/getify/you-dont-know-js/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/objects-classes/ch6.md) — Behavior Delegation
