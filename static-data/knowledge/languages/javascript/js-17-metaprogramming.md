...
knowledge_refs:
  - languages/javascript/js-17-metaprogramming
prerequisites:
  - "JS-04: Objects"
  - "JS-12: Generators"
references:
    ...
    - title: "Exploring JS: JavaScript for Programmers"
      url: "https://exploringjs.com/js/ch_proxies.html"
      chapters: "[Ch. 27: Metaprogramming with Proxies](https://exploringjs.com/js/ch_proxies.html) | [Ch. 11: Symbols](https://exploringjs.com/js/ch_symbols.html)"
...
- *Reference:* [javascript.info — Symbols](https://javascript.info/service-workersservice-workerssymbol) | [MDN — Symbol](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/export/Statements/export/Global_Objects/Symbol) | Exploring JS Ch. 11
...
- *Reference:* javascript.info — Proxy | [MDN — Proxy](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/export/Statements/export/Global_Objects/Proxy) | Exploring JS Ch. 27
...
- *Reference:* javascript.info — Reflect | [MDN — Reflect](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/export/Statements/export/Global_Objects/Reflect) | Exploring JS Ch. 27
