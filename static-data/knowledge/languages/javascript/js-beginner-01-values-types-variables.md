...
knowledge_refs:
  - languages/javascript/js-beginner-01-values-types-variables
prerequisites:
...
references:
    ...
    - title: "Exploring JS: JavaScript for Programmers"
      ...
      chapters: "Ch. 5: Values | Ch. 6: Operators | Ch. 8: Numbers | Ch. 9: Strings"
...
- *Reference:* MDN Guide — Grammar and Types | YDKJSY — Get Started Ch. 2
...
- *Reference:* javascript.info — Variables | MDN — let, const | YDKJSY — Scope & Closures Ch. 6
- *Deep dive:* See YDKJSY Scope & Closures Ch. 6 "The (Not So) Secret Lifecycle of Variables"
...
- *Reference:* javascript.info — Type Conversions | YDKJSY — Types & Grammar Ch. 4
...
- *Reference:* Eloquent JS Ch. 4 | MDN — Working with Objects | javascript.info — Objects
