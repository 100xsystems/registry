...
knowledge_refs:
  - languages/javascript/js-12-higher-order-generators
prerequisites:
  - "JS-03: Functions"
...
- *Reference:* Eloquent JS Ch. 5 | [javascript.info — Currying](https://javascript.info/service-workersservice-workerscurrying-partials) | Exploring JS Ch. 16
...
- *Reference:* [javascript.info — Iterables](https://javascript.info/service-workersservice-workersiterable) | MDN — Iterators and generators | Exploring JS Ch. 22
...
- *Reference:* [javascript.info — Generators](https://javascript.info/service-workersservice-workersgenerators) | Eloquent JS Ch. 22 | [MDN — function*](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/export/Statements/export/Statements/function*)
  | [YDKJSY — Sync & Async Ch. 4](https://github.com/getify/you-dont-know-js/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/sync-async/ch4.md)
...
- *Reference:* [javascript.info — Async iterators and generators](https://javascript.info/service-workersservice-workersasync-iterators-generators) | MDN — for await...of
