...
knowledge_refs:
  - languages/javascript/js-19-browser-apis-workers
prerequisites:
  - "JS-05: DOM"
  - "JS-10: Async"
  - "JS-11: Event Loop"
references:
    - title: "The Modern JavaScript Tutorial"
      url: "https://javascript.info/service-workers"
...
- *Reference:* [javascript.info — Service Workers](https://javascript.info/service-workersservice-workersservice-workers) | [MDN — Service Worker API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Canvas_API/Service_Worker_API)
...
- *Reference:* [MDN — IndexedDB API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Canvas_API/IndexedDB_API) | [javascript.info — IndexedDB](https://javascript.info/service-workersservice-workersindexeddb)
...
- *Reference:* [MDN — WebSocket API](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API/Canvas_API/WebSocket) | [javascript.info — WebSocket](https://javascript.info/service-workersservice-workerswebsocket)
