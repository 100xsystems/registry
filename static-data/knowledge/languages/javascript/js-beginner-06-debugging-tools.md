...
knowledge_refs:
  - languages/javascript/js-beginner-06-debugging-tools
prerequisites:
  - "JS-01 through JS-05"
references:
...
- *Reference:* MDN — Error | javascript.info — Custom errors | Eloquent JS Ch. 8
...
- *Reference:* javascript.info — Error handling | MDN — try...catch
