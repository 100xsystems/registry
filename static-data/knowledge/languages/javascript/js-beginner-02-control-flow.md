...
knowledge_refs:
  - languages/javascript/js-beginner-02-control-flow
prerequisites:
...
references:
    ...
    - title: "Exploring JS: JavaScript for Programmers"
      ...
      chapters: "Ch. 7: Control Flow | Ch. 6: Operators"
...
- *Reference:* javascript.info — Conditional operators | MDN — if...else | Eloquent JS Ch. 2
...
- *Reference:* javascript.info — Logical operators | MDN — Logical operators | YDKJSY Get Started
...
- *Reference:* javascript.info — Error handling, "try..catch" | MDN — try...catch
