---
title: "Type Coercion, Equality, and Grammar"
...
knowledge_refs:
  - languages/javascript/js-15-coercion-equality
prerequisites:
  - "JS-01 through JS-14"
references:
    - title: "You Don't Know JS Yet"
      url: "https://github.com/getify/you-dont-know-js/blob/2nd-ed/types-grammar/ch1.md"
    ...
    - title: "Exploring JS: JavaScript for Programmers"
      ...
      chapters: "[Ch. 6: Operators](https://exploringjs.com/js/ch_operators.html) | [Ch. 7: Control Flow](https://exploringjs.com/js/ch_control-flow.html)"
...
- *Reference:* [YDKJSY — Types & Grammar Ch. 1](https://github.com/getify/you-dont-know-js/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/types-grammar/ch1.md)-4 | TC39 Spec Sec. 7.1 | Exploring JS Ch. 5-6
...
- *Reference:* [YDKJSY — Types & Grammar Ch. 4](https://github.com/getify/you-dont-know-js/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/types-grammar/ch4.md) | TC39 Spec Sec. 13.11 | MDN — Equality comparisons
...
- *Reference:* [YDKJSY — Types & Grammar Ch. 5](https://github.com/getify/you-dont-know-js/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/types-grammar/ch1.md/blob/2nd-ed/types-grammar/ch5.md) | TC39 Spec Sec. 13 (all expressions)
